<!--
  douglas-floriano · github profile
  ────────────────────────────────────
  estilo editorial · senior fullstack
-->

<a href="https://douglas-floriano.github.io/">
  <img
    src="https://capsule-render.vercel.app/api?type=waving&color=0:0F0E0C,100:E2410E&height=220&section=header&text=floriano.&fontSize=78&fontColor=F2EDE3&fontAlignY=42&desc=Studio%20of%20one%20·%20Senior%20Full%20Stack&descAlignY=68&descSize=14&descColor=F2EDE3"
    alt="floriano. — studio of one"
  />
</a>
...
<p align="left">
  ...
  <a href="https://www.instagram.com/douglasflorianoc/">
    <img alt="Instagram" src="https://img.shields.io/badge/INSTAGRAM-%40douglasflorianoc-E4405F?style=for-the-badge&labelColor=0F0E0C" />
  </a>
</p>
...
┌──────────────────────────────────────────────────────────────────────────┐
│                                                                          │
│   Douglas Floriano Costa · Desenvolvedor Sênior FullStack                │
│   Itirapuã / SP — Brasil  ·  Disponível remoto global                    │
│                                                                          │
│   ● Construo software que paga conta — não protótipo, não tutorial,      │
│     não toy project. Sistemas que rodam em produção, com usuários        │
│     pagantes reais, há anos. Banco de dados ao pixel.                    │
│                                                                          │
└──────────────────────────────────────────────────────────────────────────┘
```
...
| | |
|---|---|
| **Função**       | Dev sênior fullstack na **IB System** |
| **Mantenho**     | 4 SaaS críticos em produção (loteamento, ingresso, investimento, capital) |
| **Construo**     | 2 produtos próprios — `HASGym` (gestão de academia) e `Comanda.Sys` (operação de bar/restaurante) |
| **Disponível**   | Freelance & consultoria · remoto |
| **Foco**         | SaaS B2B · fintech · multi-tenant · operações 24/7 |

---

## №02 &nbsp;·&nbsp; Ferramental de um sênior
...
### Construído na **IB System**
4 plataformas em produção, com infra AWS multi-tenant.

- **Lotemobile / WalletLote** — SaaS para loteadoras e incorporadoras
- **IBticket** — venda e validação de ingressos com QR ao vivo
- **HRT Invest** — investimentos · web + app nativo + motor financeiro
- **IB3 Capital** — gestão de capital e operações institucionais

</td>
<td valign="top" width="50%">

### Produtos pessoais
Construídos do zero — sozinho. Discovery, design, código, deploy.

- **HASGym** — gestão de academia · web + app nativo · multi-academia
- **Comanda.Sys** — operação completa de bar/restaurante · multi-tenant por slug · cardápio público + canal WhatsApp
...
```
01.  Código que dura mais que sprint.       Boring tech, bem aplicada.
02.  Banco de dados é design.               Schema antes de tela.
03.  Deploy é parte do produto.             Push → prod, automatizado.
04.  Operação importa mais que feature.     Estável > bonito quebrado.
```
...
<p align="center">
  <em>"Faço o que uma squad inteira faria, com a vantagem de não ter reunião."</em><br/>
  <sub>— sobre tocar produto sozinho</sub>
</p>

<p align="center">
  <a href="https://douglas-floriano.github.io/">
    <img src="https://img.shields.io/badge/⌁_FALAR_DE_PROJETO-0F0E0C?style=for-the-badge&labelColor=E2410E&color=0F0E0C" alt="contato" />
  </a>
</p>
